...
if redis:get(max.."getidstatus"..msg.chat_id_) == "Photo" then
	if data.photos_[0] then 
		ali = {'بمكن ازحف😹😌','لأقہيہمہه للقہمہر أمہأمہ وجہهكہ🌚🥀','خٰ̐ہليِٰہنَِہيِٰہ آحہٰٰبّہڪٰྀہٰٰ🙈❤️','بّہبّہڪٰྀہٰٰنَِہ خٰ̐ہآصۛہٰٰ 🌚😹','نہـكہـبہـل 🙈♥','لاخلقه ولا اخلاق☹️😹','يحفظك ابو هاشم🌚😹','ش̷ـــۛهہٰ۫ﹻل ؏ٰـس̷ِـــﮧٰ͜ـ͡ل ،₍🍯😻⁾ ','يہٳحہلہﯝ مْنٍيہنٍ ٳلہلہه جہٳٻًكُہ🙈❤️','طہٰيٰحہٰ آلہٰلہٰهٰہٰٖ حہٰظہٰككہٰ ہٰوحہٰظہٰ آبٰٰہٰوككہٰ😹','مہٰآرَتہٰآحہٰلہٰككہٰ😐','تہٰحہٰبٰٰنہٰيٰ؟🙈',
		}
	...
	if redis:get("KLISH:ID") then
		...
		sendMsg(msg.chat_id_,msg.id_,'📬┇لا يمكنني عرض صورتك لان المشرفين قامو بتعطيل الايدي بالصوره او انك قمت بحظر البوت ...!\n🎫┇معرفـك['..UserNameID..']\n🎟┇ايديـك ❪ '..msg.sender_user_id_..' ❫\n📡┇رتبتـك ❪ '..msg.TheRank..' ❫\n🎲┇تفاعلك ❪ '..Get_Ttl(msgs)..' ❫\n💬┇رسائلك ❪ '..msgs..' ❫\n🚸┇سحكاتـك ❪ '..rfih..' ❫\n📞┇الـجـهـات ❪ '..NumGha..' ❫\n💎┇مجوهراتك ❪ '..nko..' ❫\n')
		end
end
...
return [[
┇اهلا بك في سورس الكومدان⚜┇اقوه السورسات في تلكرام ـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ ┇لتنصيب السورس ↓↑ ┇افتح ترمنال جديد ┇انسخ رابط كيثاب السورس ↡
